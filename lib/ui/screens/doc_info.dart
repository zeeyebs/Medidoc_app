...
class _docInfoPageState extends State<docInfoPage> {
          ...
          children: <Widget>[
            Container(
              ...
              child: Container(
                ...
                child: Image.asset('assets/images/search_doc_1.png'),
              ),
            ),
            Container(
  ...
  Container timeSlotWidget(String date, String month, String slotType, String time) {
    return Container(
      ...
      width: MediaQuery.of(context).size.width,
      decoration: BoxDecoration(
          borderRadius: BorderRadius.all(Radius.circular(20)), color: docContentBgColor),
      child: Container(
        padding: EdgeInsets.all(10),
        child: Row(
          children: <Widget>[
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    "$date",
                    style: TextStyle(
                        color: dateBgColor, fontSize: 30, fontWeight: FontWeight.w800),
                  ),
                  Text(
                    "$month",
                    style: TextStyle(
                        color: dateBgColor, fontSize: 20, fontWeight: FontWeight.w800),
                  )
                ],
              ),
            ),
