...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: WelcomeScreen(),
      routes: {
        '/SignInScreen': (context) => DocInfoPage(),
      },
    );
  }
}
                      ...
                      Container(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: <Widget>[
                              createDocWidget(
                                  "search_doc_1.png", "Kiran Nelson"),
                              createDocWidget("search_doc_2.png", "Gina Asare"),
                              createDocWidget("search_doc_3.png", "John Edoo"),
                              createDocWidget(
                                  "search_doc_4.png", "Salina Zaman"),
                              createDocWidget("search_doc_1", "Kiran Nelson"),
                              createDocWidget("search_doc_2", "Gina Asare"),
                            ],
                          ),
                        ),
                      )
